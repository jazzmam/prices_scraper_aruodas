...
def collectData():
	...
	pages_nr = ["", "/puslapis/2", "/puslapis/3"]


	for page_nr in pages_nr:

		page = requests.get('https://www.aruodas.lt/gyvenamieji-namai/vilniaus-rajone'+page_nr+'/?FBuildingType=box&FAreaOverAllMin=55&FAreaOverAllMax=150&FPriceMax=100000&FPriceMin=55000', headers=headers)
